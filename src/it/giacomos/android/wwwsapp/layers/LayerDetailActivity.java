...
/**
 * An activity representing a single Layer detail screen. This activity is only
 * used on handset devices. On tablet-size devices, item details are presented
 * side-by-side with a list of items in a {@link LayerListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link LayerDetailFragment}.
 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			getFragmentManager().beginTransaction()
					.add(R.id.layer_detail_container, fragment).commit();
		}
	}
