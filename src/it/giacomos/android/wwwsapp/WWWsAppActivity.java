...
import it.giacomos.android.wwwsapp.interfaceHelpers.RadarImageTimestampTextBuilder;
import it.giacomos.android.wwwsapp.interfaceHelpers.TitlebarUpdater;
import it.giacomos.android.wwwsapp.interfaceHelpers.ToastMessageManager;
...
import it.giacomos.android.wwwsapp.network.DownloadManager;
...
import it.giacomos.android.wwwsapp.network.Data.DataPoolErrorListener;
...
import it.giacomos.android.wwwsapp.observations.NearestObservationData;
...
import it.giacomos.android.wwwsapp.pager.ViewPagerPages;
...
import it.giacomos.android.wwwsapp.slidingtablayout.SlidingTabLayout;
import it.giacomos.android.wwwsapp.widgets.AnimatedImageView;
import it.giacomos.android.wwwsapp.widgets.ForecastImgTouchEventListener;
import it.giacomos.android.wwwsapp.widgets.ImgTouchEventData;
...
import it.giacomos.android.wwwsapp.widgets.map.RadarOverlayUpdateListener;
 ...
 */
public class WWWsAppActivity extends ActionBarActivity 
...
//		Log.e("WWWsAppActivity.onResume", "onResume called");
	...
	public void onPause()
	{
		...
		//		Log.e("WWWsAppActivity.onPause", "stopping pending tasks");
...
//		Log.e("WWWsAppActivity.onSelectionDone", " type " + observationType + " mode " + mapMode);
	...
	public void startReportActivity()
	{
		...
		else
		{
			...
			//			else
			//				Log.e("WWWsAppActivity.startReportActivity", "startingActivity without locality");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) 
	{
		...
		{
			//			Log.e("WWWsAppActivity.onActivityResult", "resultCode " + resultCode + " data " + data + " OK " +
			...
			//			Log.e("WWWsAppActivity.onActivityResult", "conditionsAccepted " + conditionsAccepted);
	...
	{
		Log.e("WWWsAppActivity", "onNewsUpdateAvailable " + System.currentTimeMillis());
	...
	public boolean dispatchTouchEvent(MotionEvent event) 
	{
		if(mCurrentFragmentId == 0)
		{
			FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fabNewReport);
			float y = event.getY();
			//Log.e("WWWsAppActivity.dispatchTouchEvent", " lat tou" + mLastTouchedY + " y " + y);
	...
	public void onPersonalMessageUpdate(String d, boolean fromCache) 
	{
		...
		//		Log.e("WWWsAppActivity.onPersonalMessageUpdate", "raw data \"" + d + "\"");
	...
	public void onCheckComplete(boolean ok, String error, boolean purchased) {
		Log.e("WWWsAppActivity.onCheckComplete", " ok " + ok + " error: " + error + " purchased " + purchased);
